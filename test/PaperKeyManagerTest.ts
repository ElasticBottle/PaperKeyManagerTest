...
describe("PaperKeyManagerTest", function () {
  ...
  async function createDefaultSignatureFrom(signer: Wallet) {
    // This will be generated by us.
    const nonce = ethers.utils.formatBytes32String(getSignatureNonce());

    // this is what you have to do in Solidity before calling the verify method in Paper. Refer to `/contracts/PaperKeyManagerTester.sol` for more
    ...
    // This is what paper do before we verify the signature in our PaperKeyManager
